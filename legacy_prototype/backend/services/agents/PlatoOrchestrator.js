 ...
 */
async function route({ goal, userId = 'system', conversationId = null, conversationHistory = [], targetAgentId = null, allowWeb = true, studyMode = false, budget = {}, approvedTools = [], workload = 'chat' }) {
